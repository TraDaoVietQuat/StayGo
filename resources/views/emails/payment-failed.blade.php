...
<head>
<meta charset="UTF-8">
<title>Thanh toán thất bại - StayGo</title>
<style>
...
.alert-box{background:#fef2f2;border:2px solid #fecaca;border-radius:12px;padding:20px 24px;text-align:center;margin-bottom:20px;}
.alert-icon{font-size:36px;margin-bottom:8px;}
.alert-title{font-size:16px;font-weight:700;color:#dc2626;margin-bottom:4px;}
...
<div class="wrap">
  ...
  <div class="body">
    ...
    <div class="sub">Rất tiếc, giao dịch thanh toán cho đặt phòng của bạn đã không được xử lý thành công.</div>

    <div class="alert-box">
      <div class="alert-icon">❌</div>
      <div class="alert-title">Thanh toán thất bại</div>
      <div class="alert-sub">Đặt phòng #{{ $booking->order_code }} vẫn đang chờ thanh toán</div>
    </div>

    <div class="info-box">
      <div class="row"><span class="lbl">Mã đặt phòng</span><span class="val" style="color:#dc2626;">{{ $booking->order_code }}</span></div>
